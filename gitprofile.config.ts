...
const CONFIG = {
  github: {
    username: 'pyousip', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  seo: {
    title: 'Portfolio of Phillip Yousip',
    description: '',
    imageURL: '',
  },
  social: {
  ...
  skills: [
    'Lab Data Collection',
    'Chemistry lab extraction',
    'Chemistry lab filtration',
    'Chemistry lab separation',
    'NMR Data collection',
    'TLC',
